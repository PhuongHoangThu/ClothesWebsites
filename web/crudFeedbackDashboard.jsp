                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <c:forEach items="${sessionScope.listFeedback}" var = "listFeedback">
                                                    <tr class="gradeA">
                                                        <td>${listFeedback.user.fullname}</td>
                                                        <td>${listFeedback.product.name}</td>
                                                        <td><img width="40px" height="40px" src="${listFeedback.product.image}" ></td>
                                                        <td>${listFeedback.content}</td>
                                                        <td>
                                                            <a href="#" onclick="doDelete('${listFeedback.id}')" ><i class="fa-solid fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>

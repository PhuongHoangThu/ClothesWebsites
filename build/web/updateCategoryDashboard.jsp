                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <form action="updateCategory" >
                                            <c:set value="${sessionScope.category}" var="c" ></c:set>
                                                <table class="table table-striped table-bordered table-hover" >
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><input type="text" name="name" value="${c.categoryname}"></td>
                                                    </tr>
                                                    <tr><td><input type="text" hidden name="cid" value="${c.id}"></td></tr>
                                                </tbody>
                                            </table>

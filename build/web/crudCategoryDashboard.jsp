                    ...
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="listFeedback">Phản hồi</a>
                                </li>
                                <li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            <thead>
                                                <tr>
                                                    <th>Tên danh mục</th>
                                                    <th>Thêm/Sửa/Xóa danh mục</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach items="${sessionScope.listcategory}" var = "listcategory">
                                                    <tr class="gradeA">
                                                        <td>${listcategory.categoryname}</td>
                                                        <td>
                                                            <a href="authencategory?action=update&cid=${listcategory.id}" ><i class="fa-solid fa-pen-to-square"></i></a>&nbsp;&nbsp;
                                                            <a href="authencategory?action=add" ><i class="fa-sharp fa-solid fa-plus"></i></a>&nbsp;&nbsp;
                                                            <a href="authencategory?action=delete&cid=${listcategory.id}" ><i class="fa-solid fa-trash"></i></a>&nbsp;&nbsp;
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
        ...
        <script type="text/javascript">
            function doDelete(id) {
                if (confirm("are U sure to delete" + id + "?")) {
                    window.location.href = "authenFeedback?action=delete&fid=" + id;
                }
            }
        </script>
        <!-- Custom Js -->

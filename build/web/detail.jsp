...
<html lang="en">
    ...
    <body>
        ...
        <!-- Shop Detail Start -->
        <c:set value="${sessionScope.product}" var = "product"></c:set>
            <div class="container-fluid py-5">
                ...
                <div class="col-lg-7 pb-5">
                    ...
                    <c:if test = "${product.productSale == null}">
                        <h6><fmt:formatNumber pattern="###,###,###" value = "${product.price}" type = "number"/>VNĐ</h6>
                    </c:if >
                    <c:if test = "${product.productSale != null}">
                        <h6><fmt:formatNumber pattern="###,###,###" value = "${product.price - product.price * product.productSale.discount}" type = "number"/>VNĐ</h6><h6 class="text-muted ml-2"><del><fmt:formatNumber pattern="###,###,###" value = "${product.price}" type = "number"/>VNĐ</del></h6>
                    </c:if>
                    ...
                    <form name="f" action="" method="post">
                        ...
                        <div class="d-flex align-items-center mb-4 pt-2">
                            <div class="input-group quantity mr-3" style="width: 130px;">
                                ...
                                <input type="text" class="form-control bg-secondary text-center" value="1" name="num">
                                <div class="input-group-btn">
                            ...
                            <button onclick="buy('${product.id}')" class="btn btn-primary px-3" ><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                        </div>
                    </form>
        ...
        <script type="text/javascript">
            function buy(id) {
                ...
                document.f.action = "buy?pid=" + id + "&size=" + size + "&num=" + m;
                document.f.submit();
            }
        </script>

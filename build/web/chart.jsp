        ...
        <script>
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    var listchartJson = JSON.parse(xhr.responseText);
                    ...
                    for (var i = 0; i < listchartJson.length; i++) {
                        var YearRevenue = listchartJson[i];
                        labels.push(YearRevenue.month);  // Lấy tên tháng
                        data2022.push(YearRevenue.revenue2022); // Lấy số lượng năm 2022
                        data2023.push(YearRevenue.revenue2023); // Lấy số lượng 2023                        
                    }

                    // Vẽ biểu đồ đường bằng thư viện Chart.js

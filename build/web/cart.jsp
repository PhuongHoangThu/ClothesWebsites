                                ...
                                <c:set var="t" value="${t+1}"></c:set>
                                    ...
                                    <td class="align-middle">
                                        <c:if test = "${i.product.productSale == null}">
                                            <h6><fmt:formatNumber pattern="###,###,###" value = "${i.product.price}" type = "number"/>VNĐ</h6>
                                        </c:if >
                                        <c:if test = "${i.product.productSale != null}">
                                            <h6><fmt:formatNumber pattern="###,###,###" value = "${i.product.price - i.product.price * i.product.productSale.discount}" type = "number"/>VNĐ</h6
                                        </c:if>
                                    </td>
                                    <td class="align-middle">
                                    ...
                                    <td class="align-middle">
                                        <c:if test = "${i.product.productSale == null}">
                                            <h6><fmt:formatNumber pattern="###,###,###" value = "${i.product.price * i.quantity}" type = "number"/>VNĐ</h6>
                                        </c:if >
                                        <c:if test = "${i.product.productSale != null}">
                                            <h6><fmt:formatNumber pattern="###,###,###" value = "${(i.product.price - i.product.price * i.product.productSale.discount)*i.quantity}" type = "number"/>VNĐ</h6
                                        </c:if>
                                    </td>
                                    <td class="align-middle">  
